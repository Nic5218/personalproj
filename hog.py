...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while i < num_rolls:
        ...
        if roll_result == 1:
            store_one = True
        score_sum = score_sum + roll_result
        i += 1
...
def piggy_points(score):
    ...
    # BEGIN PROBLEM 2
    sqrd_score = score ** 2
    last_digit = sqrd_score % 10
    smallest_digit = last_digit
    while sqrd_score >= 10:                          #use if statement + use variable to store the smallest
        current_digit = sqrd_score // 10 % 10
...
def more_boar(player_score, opponent_score):
    ...
    # 1. find the left most digit
    # 2. find the second left most digit
    # 3. compare two sets of digits
    def left_most(n):
        while n > 0:  
    ...
    def sec_left(n):  
        ...
        return sec_left_digit
       
            
    if player_score >= 10 and opponent_score >= 10: 
        return left_most(player_score) < left_most(opponent_score) and sec_left(player_score) < sec_left(opponent_score) 

    if player_score < 10 and opponent_score >= 10:  
        return player_score < sec_left(opponent_score)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0 :
            ...
            score0 = score0 + take_turn(num_rolls, score1, dice, goal)
            ...
            score1 = score1 + take_turn(num_rolls, score0, dice, goal)
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average(*arg):
        ...
        while i < trials_count:
            total, i = total + original_function(*arg), i + 1
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    i , max_average, current_score = 1, 0, 0
    num_dice = 0
    make_average = make_averaged(roll_dice, trials_count)
    while i <= 10:
        max_average = make_average(i, dice)
        if max_average > current_score:
            current_score = max_average
            num_dice = i
        i += 1
    return num_dice
